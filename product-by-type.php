        ...
        <div class="container">
            <div class="row">
                ...
                if (isset($_GET['LoaiSP'])) {
                    ...
                    $resultQuery = selectInfoProductByTypeAndPageIndex($type, $from, $soSpMotTrang);
                    ...
                    <div class="product-pagination text-center">
                        <nav>
                            <ul class="pagination">
                                ...
                                <?php
                                $result = selectInfoProductByType($type);
                                $tongSoSP = mysqli_num_rows($result);
                                $tongSoTrang = ceil($tongSoSP / $soSpMotTrang);
                                for ($i = 1; $i <= $tongSoTrang; $i++) {
                                ?>
                                    <li><a href="product-by-type.php?LoaiSP=<?php echo $_GET['LoaiSP']; ?>&page=<?php echo $i; ?>"> <?php echo $i; ?> </a></li>
                                <?php
                                }
                                ?>
                                <!-- <li>
