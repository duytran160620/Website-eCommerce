                    ...
                    <div class="product-content-right">
                            ...
                            <div class="col-sm-6">
                                <div class="product-inner">
                                    ...
                                    <div class="product-inner-category">
                                        <p>Đã bán: <?php echo $row['SoLuongBan'] ." Sản phẩm"; ?>.</p>
                                        <p>Lượt xem: <?php echo $row['SoLuotXem']; ?>.</p>
                                    </div>
                        ...
                        <div class="related-products-wrapper">
                            ...
                            <div class="related-products-carousel">
                                <?php
                                $resultIdSP = selectNhaSanXuatByIdSP($_GET['idSP']);
                                $rowIdNSX = mysqli_fetch_array($resultIdSP);
                                $result = selectRelatedProductByIdNSX($rowIdNSX['idNSX']);
